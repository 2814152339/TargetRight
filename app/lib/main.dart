...
class FanReplicaCard extends StatelessWidget {
  static const List<ReplicaTrackSlot> _track = <ReplicaTrackSlot>[
    ...
    ReplicaTrackSlot(left: 0.22, top: 0.42, angle: 0.00, scale: 1.00),
    ReplicaTrackSlot(left: 0.17, top: 0.57, angle: -0.12, scale: 1.00),
    ReplicaTrackSlot(left: 0.07, top: 0.73, angle: -0.28, scale: 0.99),
    ReplicaTrackSlot(left: -0.03, top: 0.89, angle: -0.43, scale: 0.98),
    ReplicaTrackSlot(left: -0.12, top: 1.06, angle: -0.55, scale: 0.96),
    ReplicaTrackSlot(left: -0.20, top: 1.23, angle: -0.67, scale: 0.94),
    ReplicaTrackSlot(
      left: -0.29,
      top: 1.39,
      angle: -0.79,
